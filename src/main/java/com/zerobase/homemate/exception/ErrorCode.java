...
public enum ErrorCode {
    ...
    CHORE_INSTANCE_ALREADY_DELETED("CHORE_INSTANCE_ALREADY_DELETED", "이미 삭제된 인스턴스입니다.", HttpStatus.CONFLICT),
    CHORE_INSTANCE_STATUS_CONFLICT("CHORE_INSTANCE_STATUS_CONFLICT", "해당 인스턴스의 상태가 요청에 맞지 않습니다.", HttpStatus.CONFLICT),
